...
export const CARDS: HomeCard[] = [
  {
    ...
    body: "A student built Mars analog rover designed for the Canadian International Rover Challenge, bringing software, structures, electronics, and payloads together into one connected system.",
    stat: "2025",
  ...
  },
  {
    ...
    body: "Rocker bogie suspension lets each wheel move independently, helping all six wheels stay in contact on uneven terrain. The drive corners use Neo Motor BLDC units, so no differential is needed.",
    stat: "6",
  ...
  },
  {
    ...
    body: "SLAM based mapping, perception, and ROS 2 integration are currently in progress. The autonomy system is still being developed and tested through both bench and field work.",
    stat: "—",
  ...
  },
  {
    ...
    body: "Spectrometry, sampling, and imaging instruments are being planned and integrated. Competition ready payload workflows are still being developed.",
    stat: "—",
    statLabel: "Development in progress",
    tags: [
      "Spectroscopy",
  ...
  },
  {
    ...
    body: "Open to all UWindsor students, giving members real engineering experience every discipline.",
    stat: "6",
    statLabel: "Sub-teams · Open",
    stat2: "50+",
    stat2Label: "Members · Active",
    tags: ["Mechanical", "Software", "Electronics", "Science", "Business", "Design"],
    startProgress: 0.81,
    endProgress: 1.0,
    side: "left",
    top: 34,
